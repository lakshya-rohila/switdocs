...
function getIconSource(name: string): AnimationObject {
  const iconMap: Record<string, AnimationObject> = {
    ...
    'pdf-rotate': require('../../../assets/animations/icons/pdf-rotate.json'),
    'pdf-watermark': require('../../../assets/animations/icons/pdf-watermark.json'),
    'pdf-lock': require('../../../assets/animations/icons/pdf-lock.json'),
    'pdf-unlock': require('../../../assets/animations/icons/pdf-unlock.json'),
