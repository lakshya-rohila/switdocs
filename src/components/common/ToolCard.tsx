...
const TOOL_IMAGES: Record<string, ImageSourcePropType> = {
  ...
  'tool-rotate-pages': require('../../../assets/images/tools/tool-rotate-pages.jpg'),
  'tool-watermark-pdf': require('../../../assets/images/tools/tool-watermark-pdf.jpg'),
  'tool-lock-pdf': require('../../../assets/images/tools/tool-lock-pdf.jpg'),
  'tool-unlock-pdf': require('../../../assets/images/tools/tool-unlock-pdf.jpg'),
  'tool-signature': require('../../../assets/images/tools/tool-signature.jpg'),
  'tool-word-to-pdf': require('../../../assets/images/tools/tool-word-to-pdf.jpg'),
  'tool-pdf-to-word': require('../../../assets/images/tools/tool-pdf-to-word.jpg'),
  'tool-pdf-to-ppt': require('../../../assets/images/tools/tool-pdf-to-ppt.jpg'),
  'tool-pdf-to-excel': require('../../../assets/images/tools/tool-pdf-to-excel.jpg'),
  'tool-image-to-pdf': require('../../../assets/images/tools/tool-image-to-pdf.jpg'),
  'tool-pdf-to-image': require('../../../assets/images/tools/tool-pdf-to-image.jpg'),
  ...
  'tool-qr-scanner': require('../../../assets/images/tools/tool-qr-scanner.jpg'),
